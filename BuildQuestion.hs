...
buildQuestionWithQInt' (Mod qi1 qi2) qi = case buildQuestionWithQInt' qi1 qi of
  ...
  Nothing -> case buildQuestionWithQInt' qi2 qi of
    ...
    Nothing -> Nothing
buildQuestionWithQInt' (Product qi1 qi2) qi = 
  case buildQuestionWithQInt' qi1 qi of
    Just qi1' -> Just $ Product qi1' qi2
    Nothing -> case buildQuestionWithQInt' qi2 qi of
      Just qi2' -> Just $ Product qi1 qi2'
      Nothing -> Nothing
buildQuestionWithQInt' (Quotient qi1 qi2) qi = 
  case buildQuestionWithQInt' qi1 qi of
...
buildQuestionWithQHand (NonEmpty qh1) qh = 
  case buildQuestionWithQHand'' qh1 qh of
    ...
    Nothing -> Nothing
buildQuestionWithQHand (Union q1 q2) qh = 
  case buildQuestionWithQHand q1 qh of
    Just q1' -> Just $ Union q1' q2
    Nothing -> case buildQuestionWithQHand q2 qh of
      Just q2' -> Just $ Union q1 q2'
      Nothing -> Nothing
buildQuestionWithQHand (Intersection q1 q2) qh = 
  case buildQuestionWithQHand q1 qh of
    Just q1' -> Just $ Intersection q1' q2
    Nothing -> case buildQuestionWithQHand q2 qh of
      Just q2' -> Just $ Intersection q1 q2'
...
buildQuestionWithQHand (Not q1) qh = case buildQuestionWithQHand q1 qh of
  Just q2 -> Just $ Not q2
  Nothing -> Nothing
buildQuestionWithQHand (Equals qi1 qi2) qh = 
  case buildQuestionWithQHand' qi1 qh of
    Just qi1' -> Just $ Equals qi1' qi2
...
buildQuestionWithQHand' (Cardinality qh1) qh = 
  case buildQuestionWithQHand'' qh1 qh of
    ...
    Nothing -> Nothing
buildQuestionWithQHand' (SumHand qh1) qh = 
  case buildQuestionWithQHand'' qh1 qh of
    Just qh2 -> Just $ SumHand qh2
    Nothing -> Nothing
buildQuestionWithQHand' (ProductHand qh1) qh = 
  case buildQuestionWithQHand'' qh1 qh of
    Just qh2 -> Just $ ProductHand qh2
    Nothing -> Nothing
buildQuestionWithQHand' (Sum qi1 qi2) qh = 
  case buildQuestionWithQHand' qi1 qh of
    Just qi1' -> Just $ Sum qi1' qi2
    Nothing -> case buildQuestionWithQHand' qi2 qh of
      Just qi2' -> Just $ Sum qi1 qi2'
      Nothing -> Nothing
buildQuestionWithQHand' (Diff qi1 qi2) qh = 
  case buildQuestionWithQHand' qi1 qh of
    Just qi1' -> Just $ Diff qi1' qi2
    Nothing -> case buildQuestionWithQHand' qi2 qh of
        Just qi2' -> Just $ Diff qi1 qi2'
        Nothing -> Nothing
buildQuestionWithQHand' (Mod qi1 qi2) qh = 
  case buildQuestionWithQHand' qi1 qh of
    Just qi1' -> Just $ Mod qi1' qi2
    Nothing -> case buildQuestionWithQHand' qi2 qh of
        Just qi2' -> Just $ Mod qi1 qi2'
        Nothing -> Nothing
buildQuestionWithQHand' (Product qi1 qi2) qh = 
  case buildQuestionWithQHand' qi1 qh of
    Just qi1' -> Just $ Product qi1' qi2
    Nothing -> case buildQuestionWithQHand' qi2 qh of
        Just qi2' -> Just $ Product qi1 qi2'
        Nothing -> Nothing
buildQuestionWithQHand' (Quotient qi1 qi2) qh = 
  case buildQuestionWithQHand' qi1 qh of
    Just qi1' -> Just $ Quotient qi1' qi2
    Nothing -> case buildQuestionWithQHand' qi2 qh of
        Just qi2' -> Just $ Quotient qi1 qi2'
